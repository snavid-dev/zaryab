...
export default function MyPodcastPage({ data, podcast }) {
  ...
  useGSAP(() => {
    if (podcast) {
      ...
      gsap.to(palyerRef.current, {
        y: 0,
        opacity: 1,
        ease: 'power2.out',
        scrollTrigger: {
          trigger: palyerRef.current,
          start: 'top 90%',
          end: 'top 70%',
          toggleActions: 'play none none none',
        },
  ...
  const similartitleRef = useRef(null);

  useGSAP(() => {
    if (data) {
      gsap.to(similartitleRef.current, {
        y: 0,
        opacity: 1,
        ease: 'power2.out',
        scrollTrigger: {
          trigger: similartitleRef.current,
          start: 'top 90%',
          end: 'top 70%',
          toggleActions: 'play none none none',
        },
    ...
    <div className="w-full min-h-100vh">
      <div className="flex flex-col items-center mt-130px xl:mt-50px mb-50px">
        ...
        <div className="main-container">
          ...
          <div
            className="col-span-6 md:col-span-4 xl:col-span-6  border-4 border-black p-14 translate-y-200px opacity-0"
            ref={imageRef}
          >
          ...
          {podcast?.name && (
            <div
              className="col-span-6 xl:col-span-12 flex justify-center rtl mt-5 font-pashto text-20px md:text-25px lg:text-30px translate-y-200px opacity-0"
              ref={titleRef}
            >
              {podcast?.name}
            </div>
          ...
          <div className="hidden md:block md:col-span-1 xl:col-span-3"></div>
          <div
            className="col-span-6 md:col-span-4 xl:col-span-6 flex justify-center items-center mt-5 rtl translate-y-200px opacity-0"
            ref={authorRef}
          >
            <div className="flex justify-start items-center rtl w-1/2">
              ...
              {podcast?.host && (
                <div className="font-pashto text-12px md:text-16px xl:text-20px">
                  {podcast?.host}
                </div>
              )}
            </div>
        ...
        <div className="main-container mt-14">
          <div
            className="col-span-6 xl:col-span-12 rtl mb-7 translate-y-200px opacity-0"
            ref={textTitleRef}
          >
          ...
          <div className="col-span-6 xl:col-span-12">
            {podcast?.content && (
              <div
                ...
                className="w-full border-t-4 border-b-4 border-black whitespace-pre-wrap rtl font-pashto
          ...
          <div className="mt-14 col-span-6 xl:col-span-12">
            {/*  it has two rows  */}
            <div
              className="flex flex-row-reverse justify-between translate-y-200px opacity-0"
              ref={similartitleRef}
            >
