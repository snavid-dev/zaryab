...
export default function Genre({ title }) {
  return (
    <div className="relative flex group h-21px">
      <div className="font-common-thin z-20 text-14px md:text-16px font-bold text-right mr-6px">
        {title}
      </div>
      <svg
        width="21"
      ...
      <div className="absolute right-0 opacity-0 bg-[#FCA30A] w-[21px] h-[21px] rounded-full group-hover:opacity-100 transition-all duration-500 delay-500"></div>
    </div>
  );
}
