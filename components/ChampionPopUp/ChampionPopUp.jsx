  ...
  return (
    ...
    >
      ...
      <div className="w-full px-5">
        <div className="rtl w-full text-footerBtn font-common-heavy text-25px md:text-30px xl:text-50px">
          برنده مسابقه داستان نویسی آوای زریاب
        </div>
        <div className="w-full relative h-200px md:h-280px xl:h-430px mt-1">
          {data?.featured_image ? (
            <Image
        ...
        <div className="w-full font-new-black text-30px xl:text-50px rtl mt-1">
          {data?.story.title}
        </div>
        <div className="w-full font-common-heavy text-16px text-footerBtn xl:text-25px rtl mt-1 flex">
          <div>نویسنده:</div>
          <div className="mr-1">{data?.author.name}</div>
        </div>
        <div className="w-full rtl font-common-regular text-10px md:text-14px xl:text-18px mt-1">
          {data?.story.excerpt}
        </div>
        <div className="w-full flex flex-row-reverse justify-between mt-3 mb-3">
          ...
          <Link
            ...
            className="flex justify-center items-center font-common-heavy text-18px px-7 py-2 md:px-12 md:text-20px md:py-3 xl:px-20 xl:py-5 xl:text-25px bg-white border-2 border-footerBtn text-footerBtn"
          >
            درباره نویسنده
          </Link>
        </div>
